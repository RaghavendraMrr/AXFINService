# TrustLine Bank - Personal Loan Website
...
## Notes
- Form submissions are sent to `mraghavendra.2005@gmail.com` using FormSubmit.
- On the first submission, FormSubmit sends an activation email to the receiver address.
   You must confirm that activation once before regular form emails are delivered.
